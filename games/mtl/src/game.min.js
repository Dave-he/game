	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://games.haoshengweb.com",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://games.haoshengweb.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://games.haoshengweb.com";
y.url = function() {
	return "http://games.haoshengweb.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://games.haoshengweb.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("豪升网络—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("豪升网络", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://games.haoshengweb.com"
			}, this);
