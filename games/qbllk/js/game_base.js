if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://games.haoshengweb.com/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://games.haoshengweb.com/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://games.haoshengweb.com/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://games.haoshengweb.com/");
...
var mebtnopenurl = "https://u.wechat.com/MFfCZQKOL-7ImgZy1wqTIJo";

window.shareData = {
    "imgUrl": "http://games.haoshengweb.com/icon/qbllk.png",
    "timeLineLink": "http://games.haoshengweb.com/games/qbllk/",
    "tTitle": "奇葩连连看-豪升网络",
